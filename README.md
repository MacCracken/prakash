...
|--------|-------|-------------|
| **ray** | ray_core, ray_fresnel, ray_trace, ray_simulate, ray_system, ray_dispersion, ray_fiber, ray_grin | Geometric optics: Snell, Fresnel (real + complex refractive index), reflection (2D/3D), critical/Brewster angle, Beer-Lambert, TIR, 12 materials. Dispersion (Sellmeier/Cauchy/Herzberger/Schott/Conrady), chromatic aberration, fiber optics. Sequential + recursive ray tracer with polarization, ray fans, spot diagrams, OPD, paraxial system builder, cardinal points. **GRIN ray tracing** (2.8.0): SELFOC, sech, radial/axial polynomial, Luneburg and Maxwell fish-eye profiles by Sharma's RK-Nyström, with optical path, rod and ball traces, SELFOC pitch and ABCD |
